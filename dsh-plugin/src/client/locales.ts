...
export const zh: ScreenshotLocaleDict = {
  ...
  warnOnTextOnlyModelHint: '当前模型不声明图片输入、或路由解析不出来时，给模型一条说明该怎么办的提示（每种原因每会话一次）。',
...
export const en: ScreenshotLocaleDict = {
  ...
  warnOnTextOnlyModelHint: 'When the current model declares no image input, or the route cannot be resolved, tell the model what to do (once per reason, per session).',
